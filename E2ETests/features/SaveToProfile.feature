# Not including a test for verifying toast message when the resource is already saved.
# Assuming unit test will cover that.
...
@SaveToProfileGivenSignedInScenario
...
@SaveToProfileGivenNotSignedInScenario
Scenario: Save a resource topic given I've not signed in
    Given I naviagte to the resource page for "Divorce" at "https://access2justicewebtesting.azurewebsites.net/topics/d1d5f7a0-f1fa-464f-8da6-c2e7ce1501ef"
    And I have not already signed in
    When I click the Save to profile button
