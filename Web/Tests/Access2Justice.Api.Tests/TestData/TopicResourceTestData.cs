...
namespace Access2Justice.Api.Tests.TestData
{
    class TopicResourceTestData
    {
        ...
        public static JArray formData =
                    ...
                    'id':'77d301e7-6df2-612e-4704-c04edf271806','name': 'Form1','type':'form','description': 'Subhead lorem ipsum solor sit amet bibodem consecuter orem ipsum solor sit amet bibodem',
                    'resourceType': 'Forms','externalUrl': 'www.youtube.com','url': 'access2justice.com','topicTags': [{'id': 'aaa085ef-96fb-4fd0-bcd0-0472ede66512'}],
        ...
        public static JArray actionPlanData =
                    ...
                    'id': '807f2e0d-c431-4f1c-b8c8-1223e6750bec','name': 'Action Plan','type':'action plan','description': 'This action plan is for tenants who are facing eviction and have experienced the following:',
                    'resourceType': 'Action Plans','externalUrl': 'www.youtube.com','url': 'access2justice.com','topicTags': [{'id': 'aaa085ef-96fb-4fd0-bcd0-0472ede66512'}],'location': [{'state': 'Hawaii','county': '','city': 'Haiku-Pauwela','zipCode': ''},{'state': 'Alaska','county': '','city': '','zipCode': ''}],
        ...
        public static JArray articleData =
                    JArray.Parse(@"[{'overview': 'Overview','headline1': 'HL1','content1': 'c1','headline2': 'HL2','content2': 'c2','id': '807f2e0d-c431-4f1c-b8c8-1223e6750bec','name': 'Article1','type':'article','description': 'Subhead lorem ipsum solor sit amet bibodem',
                    'resourceType': 'Articles','externalUrl': 'www.youtube.com','url': 'access2justice.com','topicTags': [{'id': 'aaa085ef-96fb-4fd0-bcd0-0472ede66512'}],'location': [{'state': 'Hawaii','county': '','city': 'Haiku-Pauwela','zipCode': ''},{'state': 'Alaska','county': '','city': '','zipCode': ''}],
                    'icon': './assets/images/resources/resource.png','createdBy': 'API','createdTimeStamp':'','modifiedBy': 'API','modifiedTimeStamp':''}]");
        public static JArray videoData =
                    JArray.Parse(@"[{'overview': 'Overview','isRecommended': 'Yes','videoUrl': 'Url','id': '807f2e0d-c431-4f1c-b8c8-1223e6750bec','name': 'Video','type':'video','description': 'Subhead lorem ipsum solor sit amet bibodem',
                    'resourceType': 'Videos','externalUrl': 'www.youtube.com','url': 'access2justice.com','topicTags': [{'id': 'aaa085ef-96fb-4fd0-bcd0-0472ede66512'}],'location': [{'state': 'Hawaii','county': '','city': 'Haiku-Pauwela','zipCode': ''},{'state': 'Alaska','county': '','city': '','zipCode': ''}],
                    'icon': './assets/images/resources/resource.png','createdBy': 'API','createdTimeStamp':'','modifiedBy': 'API','modifiedTimeStamp':''}]");
        public static JArray organizationData =
                    JArray.Parse(@"[{'address': '2900 E Parks Hwy Wasilla, AK 99654','telephone': '907-279-2457','overview': 'This site is a service that is made possible through the generosity of the Legal Services Corporation and is supported by a number of partner organizations throughout Alaska.  The web site was created by Pro Bono Net and is maintained by staff at Alaska Legal Services Corporation.','eligibilityInformation': 'Helping low-income individuals solve legal problems','reviewedByCommunityMember': 'AlaskaLawHelp is provided as a public service. Your feedback will help us to improve this site. If you are having difficulty using the website, or if you have suggestions on changes you would like to see (the look, functionality, or the information provided) please let us know.','reviewerFullName': 'John Smith','reviewerTitle': 'Good Alaskan grandpa',
                    'reviewerImage': '','id': '807f2e0d-c431-4f1c-b8c8-1223e6750bec','name': 'Organization','type':'org','description': 'Subhead lorem ipsum solor sit amet bibodem',
                    'resourceType': 'Organizations','externalUrl': 'www.youtube.com','url': 'access2justice.com','topicTags': [{'id': 'aaa085ef-96fb-4fd0-bcd0-0472ede66512'}],'location': [{'state': 'Hawaii','county': '','city': 'Haiku-Pauwela','zipCode': ''},{'state': 'Alaska','county': '','city': '','zipCode': ''}],
                    'icon': './assets/images/resources/resource.png','createdBy': 'API','createdTimeStamp':'','modifiedBy': 'API','modifiedTimeStamp':''}]");
        public static JArray essentialReadingData =
                    ...
                    'resourceType': 'Related Links','externalUrl': 'www.youtube.com','url': 'access2justice.com','topicTags': [{'id': 'aaa085ef-96fb-4fd0-bcd0-0472ede66512'}],'location': [{'state': 'Hawaii','county': '','city': 'Haiku-Pauwela','zipCode': ''},{'state': 'Alaska','county': '','city': '','zipCode': ''}],
                    'icon': './assets/images/resources/resource.png','createdBy': 'API','createdTimeStamp':'','modifiedBy': 'API','modifiedTimeStamp':''}]");
        ...
        public static JArray emptyResourceData = JArray.Parse(@"[{'topicTags':[{'id': ''}],'location': [{'state': '','county':'','': '','zipCode':''}],'conditions': [{'condition': {'title': '','description': ''}}],'parentTopicId':[{'id':''}], 'quickLinks':[{'text':'','url':''}] }]");
        //Mcoked Data
        ...
        public static JArray expectedVideoData =
                    JArray.Parse(@"[{  'overview': 'Overview',  'id': '807f2e0d-c431-4f1c-b8c8-1223e6750bec',  'name': 'Video',  'type': 'video',  'description': 'Subhead lorem ipsum solor sit amet bibodem',  'resourceType': 'Videos',  'externalUrl': 'www.youtube.com',  'url': 'access2justice.com',  'topicTags': [    {      'id': 'aaa085ef-96fb-4fd0-bcd0-0472ede66512'    }  ],  'location': [    {      'state': 'Hawaii',      'county': '',      'city': 'Haiku-Pauwela',      'zipCode': ''    },    {      'state': 'Alaska',      'county': '',      'city': '',      'zipCode': ''    }  ],  'icon': './assets/images/resources/resource.png',  'createdBy': 'API',  'createdTimeStamp': '',  'modifiedBy': 'API',  'modifiedTimeStamp': ''}]");
