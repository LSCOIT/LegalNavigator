...
namespace Access2Justice.Api.Tests.TestData
{
    class TopicResourceTestData
    {
        ...
        public static JArray referencesInputData =
                    ...
                    'resourceType': 'Action Plans','externalUrl': 'www.youtube.com','url': 'access2justice.com','topicTags': [{'id': 'aaa085ef-96fb-4fd0-bcd0-0472ede66512'}],'location': [{'state': 'Hawaii','county': '','city': 'Haiku-Pauwela','zipCode': ''},{'state': 'Alaska','county': '','city': '','zipCode': ''}], reviewer: [{'reviewerFullName':'Full Name','reviewerTitle':'Title','reviewText':'Text','reviewerImage':'Image'}], 'sections': [{'sectionHeadline':'headline','sectionContent':'content'}],
                    'icon': './assets/images/resources/resource.png','createdBy': 'API','createdTimeStamp':'','modifiedBy': 'API','modifiedTimeStamp':''}]");
        public static JArray articleData =
                    JArray.Parse(@"[{'overview': 'Overview','sections':[{'sectionHeadline':'headline','sectionContent':'content'}],'id': '807f2e0d-c431-4f1c-b8c8-1223e6750bec','name': 'Article1','resourceCategory':'article','description': 'Subhead lorem ipsum solor sit amet bibodem',
        ...
        public static JArray emptyResourceData = JArray.Parse(@"[{'topicTags':[{'id': ''}],'location': [{'state': '','county':'','': '','zipCode':''}],'conditions': [{'condition': {'title': '','description': ''}}],'parentTopicId':[{'id':''}], 'quickLinks':[{'text':'','url':''}], reviewer: [{'reviewerFullName':'','reviewerTitle':'','reviewText':'','reviewerImage':''}], 'sections': [{'sectionHeadline':'','sectionContent':''}] }]");
        ...
        public static JArray sectionData =
                     JArray.Parse(@"[{'sectionHeadline':'headline','sectionContent':'content'}]");
        //Mcoked Data
        ...
        public static JArray emptySectionData =
             JArray.Parse(@"[{'sectionHeadline':'','sectionContent':''}]");
        ...
        public static JArray EmptyReferences =
                     JArray.Parse(@"[[{'id':''}],[{'state':'','county':'','city':'','zipCode':''}],[{'condition':[{'title':'','description':''}]}],[{'id':''}],[{'text':'','url':''}],[{'reviewerFullName':'','reviewerTitle':'','reviewText':'','reviewerImage':''}],[{'sectionHeadline':'','sectionContent':''}]]");
        ...
        public static JArray expectedResourceReferences =
                     JArray.Parse(@"[[{'id':'aaa085ef-96fb-4fd0-bcd0-0472ede66512'}],[{'state':'Hawaii','county':'','city':'Haiku-Pauwela','zipCode':''},{'state':'Alaska','county':'','city':'','zipCode':''}], [{'sectionHeadline':'headline','sectionContent':'content'}]]");
