...
namespace Access2Justice.Api.Tests.TestData
{
	class TopicResourceTestData
	{
		...
		public static List<dynamic> resourcesData =
					JsonConvert.DeserializeObject<List<dynamic>>(@"[{'id':'77d301e7-6df2-612e-4704-c04edf271806','name':'Tenant Action Plan 
                    ...
                    'createdBy':'','createdTimeStamp':'','modifiedBy':'','modifiedTimeStamp':'','delete':'N','ranking':1,'_rid':'mwoSAJdNlwIBAAAAAAAAAA==',
                    ...
                    'createdTimeStamp':'','modifiedBy':'','modifiedTimeStamp':'','delete':'N','ranking':1,'_rid':'mwoSAJdNlwIBAAAAAAAAAA==','_self':
		...
		public static JArray videoData =
                    ...
                    'icon': './assets/images/resources/resource.png','createdBy': 'API','createdTimeStamp':'','modifiedBy': 'API','modifiedTimeStamp':'', 'nsmiCode': 'TO-05-00-00-00'}]");
		...
		public static JArray topicData =
                    ...
                    'jsonContent':'jsonContent','icon': './assets/images/resources/resource.png','createdBy': 'API','createdTimeStamp':'','modifiedBy': 'API','modifiedTimeStamp':'', 'nsmiCode':'TO-05-00-00-00' }]");
        ...
        public static JArray expectedVideoData =
                    JArray.Parse(@"[{  'overview': 'Overview',  'id': '807f2e0d-c431-4f1c-b8c8-1223e6750bec',  'name': 'Video',  'resourceCategory': 'video',  'description': 'Subhead lorem ipsum solor sit amet bibodem',  'resourceType': 'Videos',    'url': 'access2justice.com',  'topicTags': [    {      'id': 'aaa085ef-96fb-4fd0-bcd0-0472ede66512'    }  ],'organizationalUnit': 'Alaska',  'location': [    {      'state': 'Hawaii',      'county': '',      'city': 'Haiku-Pauwela',      'zipCode': ''    },    {      'state': 'Alaska',      'county': '',      'city': '',      'zipCode': ''    }  ],  'createdBy': 'API',  'createdTimeStamp': '',  'modifiedBy': 'API',  'modifiedTimeStamp': '', 'nsmiCode': 'TO-05-00-00-00' }]");
        ...
        public static JArray expectedTopicData =
                    JArray.Parse(@"[{'id': '807f2e0d-c431-4f1c-b8c8-1223e6750bec', 'overview': 'overview details', 'parentTopicId': [ { 'id': 'aaa085ef-96fb-4fd0-bcd0-0472ede66512' } ], 'keywords': 'HOUSING', 'icon': './assets/images/resources/resource.png', 'name': 'Family', 'resourceCategory': null, 'description': null, 'resourceType': 'Topics', 'url': null, 'topicTags': [], 'organizationalUnit': 'Alaska', 'location': [ { 'state': 'Hawaii', 'county': '', 'city': 'Haiku-Pauwela', 'zipCode': '' }, { 'state': 'Alaska', 'county': '', 'city': '', 'zipCode': '' } ], 'createdBy': 'API', 'createdTimeStamp': '', 'modifiedBy': 'API', 'modifiedTimeStamp': '', 'nsmiCode': 'TO-05-00-00-00' }]");
        public static JArray expectedTopicsData =
                    JArray.Parse(@"[{  'id': '807f2e0d-c431-4f1c-b8c8-1223e6750bec',  'name': 'Family',  'overview': 'overview details',  'parentTopicId': [    {      'id': 'aaa085ef-96fb-4fd0-bcd0-0472ede66512'    }  ],  'resourceType': 'Topics',  'keywords': 'HOUSING', 'organizationalUnit': 'Alaska', 'location': [    {      'state': 'Hawaii',      'county': '',      'city': 'Haiku-Pauwela',      'zipCode': ''    },    {      'state': 'Alaska',      'county': '',      'city': '',      'zipCode': ''    }  ],  'jsonContent': 'jsonContent',  'icon': './assets/images/resources/resource.png',  'createdBy': 'API',  'createdTimeStamp': '',  'modifiedBy': 'API',  'modifiedTimeStamp': '', 'nsmiCode': 'TO-05-00-00-00' }]");
