...
namespace Access2Justice.Api.Tests.TestData
{
    class TopicResourceTestData
    {
        ...
        public static JArray organizationData =
                    ...
                    'id': '807f2e0d-c431-4f1c-b8c8-1223e6750bec','name': 'Organization','type':'org','description': 'Subhead lorem ipsum solor sit amet bibodem',
        ...
        public static JArray essentialReadingData =
                    ...
                    'resourceType': 'Related Links','externalUrl': 'www.youtube.com','url': 'access2justice.com','topicTags': [{'id': 'aaa085ef-96fb-4fd0-bcd0-0472ede66512'}],'organizationalUnit': 'Alaska','location': [{'state': 'Hawaii','county': '','city': 'Haiku-Pauwela','zipCode': ''},{'state': 'Alaska','county': '','city': '','zipCode': ''}],
                    'icon': './assets/images/resources/resource.png','createdBy': 'API','createdTimeStamp':'','modifiedBy': 'API','modifiedTimeStamp':''}]");
        ...
        public static JArray emptyResourceData = JArray.Parse(@"[{'topicTags':[{'id': ''}],'location': [{'state': '','county':'','': '','zipCode':''}],'conditions': [{'condition': {'title': '','description': ''}}],'parentTopicId':[{'id':''}], 'quickLinks':[{'text':'','url':''}], reviewer: [{'reviewerFullName':'','reviewerTitle':'','reviewText':'','reviewerImage':''}] }]");
        ...
        public static JArray EmptyReferences =
                     JArray.Parse(@"[[{'id':''}],[{'state':'','county':'','city':'','zipCode':''}],[{'condition':[{'title':'','description':''}]}],[{'id':''}],[{'text':'','url':''}],[{'reviewerFullName':'','reviewerTitle':'','reviewText':'','reviewerImage':''}]]");
        ...
        public static JArray expectedVideoData =
                    JArray.Parse(@"[{  'overview': 'Overview',  'id': '807f2e0d-c431-4f1c-b8c8-1223e6750bec',  'name': 'Video',  'type': 'video',  'description': 'Subhead lorem ipsum solor sit amet bibodem',  'resourceType': 'Videos',  'externalUrl': 'www.youtube.com',  'url': 'access2justice.com',  'topicTags': [    {      'id': 'aaa085ef-96fb-4fd0-bcd0-0472ede66512'    }  ],'organizationalUnit': 'Alaska',  'location': [    {      'state': 'Hawaii',      'county': '',      'city': 'Haiku-Pauwela',      'zipCode': ''    },    {      'state': 'Alaska',      'county': '',      'city': '',      'zipCode': ''    }  ],  'icon': './assets/images/resources/resource.png',  'createdBy': 'API',  'createdTimeStamp': '',  'modifiedBy': 'API',  'modifiedTimeStamp': ''}]");
