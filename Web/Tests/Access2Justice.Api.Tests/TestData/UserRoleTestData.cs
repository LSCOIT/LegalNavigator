...
namespace Access2Justice.Api.Tests.TestData
{
    ...
    {
        public static IEnumerable<object[]> UserRoleData()
        {
            yield return new object[] { "400d79ef-3895-4eef-b7c7-c59fcfb42afe", new UserRole {RoleInformationId=Guid.Parse("400d79ef-3895-4eef-b7c7-c59fcfb42afe"), RoleName="PortalAdmin", Permissions = { "upserttopics","upsertresources","upsertstaticcontent"} } };
