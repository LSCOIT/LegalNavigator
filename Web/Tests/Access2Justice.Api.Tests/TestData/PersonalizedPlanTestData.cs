...
'topicIds': [
  ...
  },
  {
    ...
    'topicIds':['e1fdbbc6-d66a-4275-9cd2-2be84d303e12']
        ...
        {
            yield return new object[] { new PersonalizedPlanViewModel { IsShared = true, PersonalizedPlanId = Guid.Parse("6a9f4c22-b1ab-46cf-8702-41a0b9522f82"), Topics = new List<PlanTopic>() { new PlanTopic { TopicId = Guid.Parse("e1fdbbc6-d66a-4275-9cd2-2be84d303e12"), TopicName = "Family", Steps = { }, AdditionalReadings = { }, Icon = String.Empty } } }, PersonalizedPlanViewModelExpectedData };
        }
        public static PersonalizedPlanViewModel PersonalizedPlanViewModelExpectedData =>
            new PersonalizedPlanViewModel
            {
                ...
                Topics = new List<PlanTopic>() { new PlanTopic { TopicId = Guid.Parse("e1fdbbc6-d66a-4275-9cd2-2be84d303e12"), TopicName = "Family", Steps = { }, AdditionalReadings = { }, Icon = String.Empty } }
            };
        ...
        public static CuratedExperienceAnswers CuratedExperienceAnswers =>
                ...
                new CuratedExperienceAnswers
                {
                    ...
                    ButtonComponents = new List<ButtonComponent>() { new ButtonComponent { ButtonId = Guid.Parse("288af4da-06bb-4655-aa91-41314e248d6b"), CodeAfter = "test", CodeBefore = "test", Name = "test", Value = "test" } },
                    CuratedExperienceId = Guid.Parse("9a6a6131-657d-467d-b09b-c570b7dad242"),
                    FieldComponents = new List<FieldComponent>() { new FieldComponent { CodeAfter = "test", CodeBefore = "test", Fields = new List<AnswerField>() { new AnswerField { FieldId = Guid.Parse("288af4da-06bb-4655-aa91-41314e248d6b"), Name = "test", Value = "test", Text = "test" } } } }
                };
        public static IEnumerable<object[]> CuratedExperienceAnswersData()
        {
            yield return new object[] { CuratedExperience, new CuratedExperienceAnswers
                {
                    AnswersDocId = Guid.Parse("288af4da-06bb-4655-aa91-41314e248d6b"),
                    ButtonComponents = new List<ButtonComponent>() { new ButtonComponent { ButtonId = Guid.Parse("288af4da-06bb-4655-aa91-41314e248d6b"), CodeAfter = "test", CodeBefore = "test", Name = "test", Value = "test" } },
                    CuratedExperienceId = Guid.Parse("9a6a6131-657d-467d-b09b-c570b7dad242"),
        ...
        public static string CuratedExperienceAnswerInString = "[\r\n    {\r\n      'id': '288af4da-06bb-4655-aa91-41314e248d6b',\r\n      'name': 'Family',\r\n      'overview': 'Overview of the Family topic',\r\n      'quickLinks': [\r\n        {\r\n          'text': 'Family Law Self-Help Center',\r\n          'url': 'http:////courts.alaska.gov//shc//family//selfhelp.htm'\r\n        },\r\n        {\r\n          'text': 'Introduction to Family Law Video Series',\r\n          'url': 'https:////alaskalawhelp.org/resource//introduction-to-family-law-video-series?ref=OEGQX'\r\n        }\r\n      ],\r\n      'parentTopicId': [],\r\n      'resourceType': 'Topics',\r\n      'keywords': 'Family',\r\n      'location': [\r\n        {\r\n          'state': 'Hawaii',\r\n          'city': 'Kalawao',\r\n          'zipCode': '96761'\r\n        },\r\n        {\r\n          'state': 'Hawaii',\r\n          'city': 'Honolulu',\r\n          'zipCode': '96741'\r\n        },\r\n        {\r\n          'state': 'Alaska',\r\n          'city': 'Juneau',\r\n          'zipCode': '96815'\r\n        },\r\n        {\r\n          'state': 'Alaska',\r\n          'city': 'Anchorage',\r\n          'zipCode': '99507'\r\n        }\r\n      ]";
        public static CuratedExperience CuratedExperience =>
                new CuratedExperience
                {
                    A2jPersonalizedPlanId = Guid.Parse("288af4da-06bb-4655-aa91-41314e248d6b"),
                    Components = new List<CuratedExperienceComponent>() { new CuratedExperienceComponent { Code = new PersonalizedPlanEvaluator {  CodeAfter="test", CodeBefore="test"}, Buttons =new List<Button>() { new Button { Id = Guid.Parse("288af4da-06bb-4655-aa91-41314e248d6b"), Name = "test", Destination = "test", Label = "test", Value = "" } }, ComponentId = Guid.Parse("288af4da-06bb-4655-aa91-41314e248d6b"),
                        Fields = new List<Shared.Models.Field>() {new Shared.Models.Field{ Id= Guid.Parse("288af4da-06bb-4655-aa91-41314e248d6b"), Name="", InvalidPrompt="", IsRequired=true, Label="", MaxLength="", MinLength="", Type="", Value="" } },  Help="", Text="",  Learn="",  Name="",
                        Tags = new List<string>()
                  }
                    }
                };
        public static UserPlan UserPlan =>
           new UserPlan
           {
               UserId = "288af4da-06bb-4655-aa91-41314e248d6b",
               PersonalizedPlan = PersonalizedPlanViewModelExpectedData,
               saveActionPlan = true
           };
        public static IEnumerable<object[]> UserPlanData()
        {
            yield return new object[] { new UserPlan
            {
                UserId = "288af4da-06bb-4655-aa91-41314e248d6b",
                PersonalizedPlan = PersonalizedPlanViewModelExpectedData,
                saveActionPlan = true}
        ...
        public static string PersonalizedPlanString = "{\r\n  {\r\n    \"id\": \"a9f6c0db-093b-4fa8-9cde-2495087b31f6\",\r\n    \"topics\": [\r\n      {\r\n        \"topicId\": \"d1d5f7a0-f1fa-464f-8da6-c2e7ce1501ef\",\r\n        \"name\": \"Divorce\",\r\n        \"quickLinks\": [\r\n          {\r\n            \"Text\": \"Filing for Dissolution or Divorce - Ending Your Marriage\",\r\n            \"Url\": \"http://courts.alaska.gov/shc/family/shcstart.htm#issues\"\r\n          },\r\n          {\r\n            \"Text\": \"Spousal Support (Alimony)\",\r\n            \"Url\": \"https://alaskalawhelp.org/resource/spousal-support?ref=OEGQX\"\r\n          }\r\n        ],\r\n        \"icon\": \"https://cs4892808efec24x447cx944.blob.core.windows.net/static-resource/assets/images/topics/housing.svg\",\r\n        \"steps\": [\r\n          {\r\n            \"stepId\": \"66a1e288-4ab1-480f-9d29-eb16abd3ae69\",\r\n            \"type\": \"steps\",\r\n            \"title\": \"File a motion to modify if there has been a change of circumstances.\",\r\n            \"description\": \"The Motion and Affidavit for Post-Decree relief are used to request changes to a divorce or make sure the other side is followin gthe orders.\",\r\n            \"order\": 1,\r\n            \"isComplete\": false,\r\n            \"resources\": [\r\n              {\r\n                \"id\": \"19a02209-ca38-4b74-bd67-6ea941d41518\",\r\n                \"name\": \"Alaska Law Help\",\r\n                \"description\": \"AlaskaLawHelp is a guide to civil legal services and resources for low-income persons and seniors in Alaska.  This site provides information on various free and low-cost legal programs in Alaska, including basic eligibility and contact information.  Here you can find links to web sites offering helpful information, schedules of free self-help clinics, forms, and legal education documents that give you basic information on a number of legal problems.\",\r\n                \"resourceType\": \"Organizations\",\r\n                \"externalUrl\": null,\r\n                \"url\": \"https://alaskalawhelp.org/\",\r\n                \"topicTags\": null,\r\n                \"location\": [\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Kalawao\",\r\n                    \"zipCode\": \"96761\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Honolulu\",\r\n                    \"zipCode\": \"96741\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Juneau\",\r\n                    \"zipCode\": \"96815\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": \"Matanuska-Susitna Borough\",\r\n                    \"city\": \"Wasilla\",\r\n                    \"zipCode\": null\r\n                  }\r\n                ],\r\n                \"icon\": \"./assets/images/resources/resource.png\",\r\n                \"createdBy\": \"\",\r\n                \"createdTimeStamp\": null,\r\n                \"modifiedBy\": \"\",\r\n                \"modifiedTimeStamp\": \"2018-04-01T04:18:00Z\"\r\n              },\r\n              {\r\n                \"id\": \"9ca4cf73-f6c0-4f63-a1e8-2a3774961df5\",\r\n                \"name\": \"Alaska Legal Services - Bristol Bay Office\",\r\n                \"description\": \"AlaskaLawHelp is a guide to civil legal services and resources for low-income persons and seniors in Alaska.  This site provides information on various free and low-cost legal programs in Alaska, including basic eligibility and contact information.  Here you can find links to web sites offering helpful information, schedules of free self-help clinics, forms, and legal education documents that give you basic information on a number of legal problems.\",\r\n                \"resourceType\": \"Organizations\",\r\n                \"externalUrl\": null,\r\n                \"url\": \"https://alaskalawhelp.org/\",\r\n                \"topicTags\": null,\r\n                \"location\": [\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Kalawao\",\r\n                    \"zipCode\": \"96761\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Honolulu\",\r\n                    \"zipCode\": \"96741\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Juneau\",\r\n                    \"zipCode\": \"96815\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Anchorage\",\r\n                    \"zipCode\": \"99507\"\r\n                  }\r\n                ],\r\n                \"icon\": \"./assets/images/resources/resource.png\",\r\n                \"createdBy\": \"\",\r\n                \"createdTimeStamp\": null,\r\n                \"modifiedBy\": \"\",\r\n                \"modifiedTimeStamp\": \"2018-04-01T04:18:00Z\"\r\n              },\r\n              {\r\n                \"id\": \"49779468-1fe0-4183-850b-ff365e05893e\",\r\n                \"name\": \"Alaska Native Justice Center\",\r\n                \"description\": \"AlaskaLawHelp is a guide to civil legal services and resources for low-income persons and seniors in Alaska.  This site provides information on various free and low-cost legal programs in Alaska, including basic eligibility and contact information.  Here you can find links to web sites offering helpful information, schedules of free self-help clinics, forms, and legal education documents that give you basic information on a number of legal problems.\",\r\n                \"resourceType\": \"Organizations\",\r\n                \"externalUrl\": null,\r\n                \"url\": \"https://alaskalawhelp.org/\",\r\n                \"topicTags\": null,\r\n                \"location\": [\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Kalawao\",\r\n                    \"zipCode\": \"96761\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Honolulu\",\r\n                    \"zipCode\": \"96741\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Juneau\",\r\n                    \"zipCode\": \"96815\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Anchorage\",\r\n                    \"zipCode\": \"99507\"\r\n                  }\r\n                ],\r\n                \"icon\": \"./assets/images/resources/resource.png\",\r\n                \"createdBy\": \"\",\r\n                \"createdTimeStamp\": null,\r\n                \"modifiedBy\": \"\",\r\n                \"modifiedTimeStamp\": \"2018-04-01T04:18:00Z\"\r\n              }\r\n            ]\r\n          },\r\n          {\r\n            \"stepId\": \"38f04325-af65-48ea-a418-d34dc477b753\",\r\n            \"type\": \"steps\",\r\n            \"title\": \"Jurisdiction\",\r\n            \"description\": \"Jurisdiction is a very complicated subject and you should talk to an attorney to figure out where is the best place ot file your case. Here are some resources that could help you with this:\",\r\n            \"order\": 2,\r\n            \"isComplete\": false,\r\n            \"resources\": [\r\n              {\r\n                \"id\": \"4f327a5b-9a79-466e-98be-2542eb28bb28\",\r\n                \"name\": \"Guardian ad Litem or Custody Investigator?\",\r\n                \"description\": \"AlaskaLawHelp is a guide to civil legal services and resources for low-income persons and seniors in Alaska.  This site provides information on various free and low-cost legal programs in Alaska, including basic eligibility and contact information.  Here you can find links to web sites offering helpful information, schedules of free self-help clinics, forms, and legal education documents that give you basic information on a number of legal problems.\",\r\n                \"resourceType\": \"Articles\",\r\n                \"externalUrl\": null,\r\n                \"url\": \"www.courtrecords.alaska.gov\",\r\n                \"topicTags\": null,\r\n                \"location\": [\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Kalawao\",\r\n                    \"zipCode\": \"96761\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Honolulu\",\r\n                    \"zipCode\": \"96741\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Juneau\",\r\n                    \"zipCode\": \"96815\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Anchorage\",\r\n                    \"zipCode\": \"99507\"\r\n                  }\r\n                ],\r\n                \"icon\": \"./assets/images/resources/resource.png\",\r\n                \"createdBy\": \"Alaska Court System Administrative Office\",\r\n                \"createdTimeStamp\": null,\r\n                \"modifiedBy\": \"\",\r\n                \"modifiedTimeStamp\": \"2018-04-01T04:18:00Z\"\r\n              },\r\n              {\r\n                \"id\": \"be0cb3e1-7054-403a-baac-d119ea5be007\",\r\n                \"name\": \"Filing Documents by Mail\",\r\n                \"description\": \"Formal Application Process\",\r\n                \"resourceType\": \"Videos\",\r\n                \"externalUrl\": null,\r\n                \"url\": \"https://www.youtube.com/embed/pCPGSTYsYoU\",\r\n                \"topicTags\": null,\r\n                \"location\": [\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Kalawao\",\r\n                    \"zipCode\": \"96761\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Honolulu\",\r\n                    \"zipCode\": \"96741\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Juneau\",\r\n                    \"zipCode\": \"96815\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": \"Matanuska-Susitna Borough\",\r\n                    \"city\": \"Wasilla\",\r\n                    \"zipCode\": \"99654\"\r\n                  }\r\n                ],\r\n                \"icon\": \"./assets/images/resources/resource.png\",\r\n                \"createdBy\": \"\",\r\n                \"createdTimeStamp\": null,\r\n                \"modifiedBy\": \"\",\r\n                \"modifiedTimeStamp\": \"2018-04-01T04:18:00Z\"\r\n              },\r\n              {\r\n                \"id\": \"2cb89c44-f989-42ea-b038-419e5006e8ff\",\r\n                \"name\": \"Innocent Spouse Relief\",\r\n                \"description\": \"AlaskaLawHelp is a guide to civil legal services and resources for low-income persons and seniors in Alaska.  This site provides information on various free and low-cost legal programs in Alaska, including basic eligibility and contact information.  Here you can find links to web sites offering helpful information, schedules of free self-help clinics, forms, and legal education documents that give you basic information on a number of legal problems.\",\r\n                \"resourceType\": \"Articles\",\r\n                \"externalUrl\": null,\r\n                \"url\": \"www.courtrecords.alaska.gov\",\r\n                \"topicTags\": null,\r\n                \"location\": [\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Kalawao\",\r\n                    \"zipCode\": \"96761\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Honolulu\",\r\n                    \"zipCode\": \"96741\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Juneau\",\r\n                    \"zipCode\": \"96815\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Anchorage\",\r\n                    \"zipCode\": \"99507\"\r\n                  }\r\n                ],\r\n                \"icon\": \"./assets/images/resources/resource.png\",\r\n                \"createdBy\": \"Alaska Court System Administrative Office\",\r\n                \"createdTimeStamp\": null,\r\n                \"modifiedBy\": \"\",\r\n                \"modifiedTimeStamp\": \"2018-04-01T04:18:00Z\"\r\n              },\r\n              {\r\n                \"id\": \"2fe9f117-bfb5-469f-b80c-877640a29f75\",\r\n                \"name\": \"Behavior in Court\",\r\n                \"description\": \"Courtroom Etiquette\",\r\n                \"resourceType\": \"Videos\",\r\n                \"externalUrl\": null,\r\n                \"url\": \"https://www.youtube.com/embed/pCPGSTYsYoU\",\r\n                \"topicTags\": null,\r\n                \"location\": [\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Kalawao\",\r\n                    \"zipCode\": \"96761\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Honolulu\",\r\n                    \"zipCode\": \"96741\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Juneau\",\r\n                    \"zipCode\": \"96815\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Anchorage\",\r\n                    \"zipCode\": \"99507\"\r\n                  }\r\n                ],\r\n                \"icon\": \"./assets/images/resources/resource.png\",\r\n                \"createdBy\": \"\",\r\n                \"createdTimeStamp\": null,\r\n                \"modifiedBy\": \"\",\r\n                \"modifiedTimeStamp\": \"2018-04-01T04:18:00Z\"\r\n              }\r\n            ]\r\n          },\r\n          {\r\n            \"stepId\": \"da519dde-3710-4515-aac1-65a576cdcc8d\",\r\n            \"type\": \"steps\",\r\n            \"title\": \"Pre-Decree Relief\",\r\n            \"description\": \"Read instructions on how to fill out a request for pre-decree relief. Fill out the form and serve the other side with a copy. Either a family court clerk or a family court judge will sign the Order for Pre-Decree Relief depending on the types of relief being requested.\",\r\n            \"order\": 3,\r\n            \"isComplete\": false,\r\n            \"resources\": [\r\n              {\r\n                \"id\": \"b0dc6222-a0a8-4927-a398-ccf0d6524593\",\r\n                \"name\": \"Common Questions About Child Support\",\r\n                \"description\": \"FAQs About Child Support\",\r\n                \"resourceType\": \"Essential Readings\",\r\n                \"externalUrl\": null,\r\n                \"url\": \"https://alaskalawhelp.org/resource/common-questions-about-child-support?ref=vhU5v\",\r\n                \"topicTags\": null,\r\n                \"location\": [\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Kalawao\",\r\n                    \"zipCode\": \"96761\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Honolulu\",\r\n                    \"zipCode\": \"96741\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Juneau\",\r\n                    \"zipCode\": \"96815\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Anchorage\",\r\n                    \"zipCode\": \"99507\"\r\n                  }\r\n                ],\r\n                \"icon\": \"./assets/images/resources/resource.png\",\r\n                \"createdBy\": \"\",\r\n                \"createdTimeStamp\": null,\r\n                \"modifiedBy\": \"\",\r\n                \"modifiedTimeStamp\": \"2018-04-01T04:18:00Z\"\r\n              },\r\n              {\r\n                \"id\": \"78a4da0f-3087-4513-8b45-a486919d2ed5\",\r\n                \"name\": \"My PFD Was Taken for Child Support, But I Have Custody of the Child\",\r\n                \"description\": \"FAQs About Child Support\",\r\n                \"resourceType\": \"Essential Readings\",\r\n                \"externalUrl\": null,\r\n                \"url\": \"https://alaskalawhelp.org/resource/my-pfd-was-taken-for-child-support-but-i-have?ref=vhU5v\",\r\n                \"topicTags\": null,\r\n                \"location\": [\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Kalawao\",\r\n                    \"zipCode\": \"96761\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Honolulu\",\r\n                    \"zipCode\": \"96741\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Juneau\",\r\n                    \"zipCode\": \"96815\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Anchorage\",\r\n                    \"zipCode\": \"99507\"\r\n                  }\r\n                ],\r\n                \"icon\": \"./assets/images/resources/resource.png\",\r\n                \"createdBy\": \"\",\r\n                \"createdTimeStamp\": null,\r\n                \"modifiedBy\": \"\",\r\n                \"modifiedTimeStamp\": \"2018-04-01T04:18:00Z\"\r\n              },\r\n              {\r\n                \"id\": \"ce2c727a-1035-4614-b6e8-a161141f245e\",\r\n                \"name\": \"Who is the Father?\",\r\n                \"description\": \"FAQs About Child Support\",\r\n                \"resourceType\": \"Essential Readings\",\r\n                \"externalUrl\": null,\r\n                \"url\": \"https://alaskalawhelp.org/resource/how-do-i-establish-paternity-of-a-child?ref=vhU5v\",\r\n                \"topicTags\": null,\r\n                \"location\": [\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Kalawao\",\r\n                    \"zipCode\": \"96761\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Honolulu\",\r\n                    \"zipCode\": \"96741\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Juneau\",\r\n                    \"zipCode\": \"96815\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Anchorage\",\r\n                    \"zipCode\": \"99507\"\r\n                  }\r\n                ],\r\n                \"icon\": \"./assets/images/resources/resource.png\",\r\n                \"createdBy\": \"\",\r\n                \"createdTimeStamp\": null,\r\n                \"modifiedBy\": \"\",\r\n                \"modifiedTimeStamp\": \"2018-04-01T04:18:00Z\"\r\n              },\r\n              {\r\n                \"id\": \"9b8bd927-ad8f-416f-9d5f-82ee96925357\",\r\n                \"name\": \"Jurisdiction of my interview\",\r\n                \"description\": \"This A2J Guided Interview was created to demonstrate that A2J Author can be used to create a curated experience around divorce for Alaska and Hawaii\",\r\n                \"resourceType\": \"Guided Assistant\",\r\n                \"externalUrl\": \"9a6a6131-657d-467d-b09b-c570b7dad242\",\r\n                \"url\": null,\r\n                \"topicTags\": null,\r\n                \"location\": [\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Kalawao\",\r\n                    \"zipCode\": \"96761\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Honolulu\",\r\n                    \"zipCode\": \"96741\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Juneau\",\r\n                    \"zipCode\": \"96815\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Alaska\",\r\n                    \"county\": null,\r\n                    \"city\": \"Anchorage\",\r\n                    \"zipCode\": \"99507\"\r\n                  },\r\n                  {\r\n                    \"state\": \"New York\",\r\n                    \"county\": null,\r\n                    \"city\": \"EAST MEADOW\",\r\n                    \"zipCode\": \"11554\"\r\n                  },\r\n                  {\r\n                    \"state\": \"NY\",\r\n                    \"county\": null,\r\n                    \"city\": \"EAST MEADOW\",\r\n                    \"zipCode\": \"11554\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Washington\",\r\n                    \"county\": null,\r\n                    \"city\": \"Redmond\",\r\n                    \"zipCode\": \"98052\"\r\n                  }\r\n                ],\r\n                \"icon\": null,\r\n                \"createdBy\": null,\r\n                \"createdTimeStamp\": null,\r\n                \"modifiedBy\": null,\r\n                \"modifiedTimeStamp\": null\r\n              },\r\n              {\r\n                \"id\": \"bbb88efb-3816-218b-5b38-1281e1b77f5a\",\r\n                \"name\": \"Hawaii Organization Test\",\r\n                \"description\": \"HawaiiLawHelp is a guide to civil legal services and resources for low-income persons and seniors in Alaska.  This site provides information on various free and low-cost legal programs in Alaska, including basic eligibility and contact information.  Here you can find links to web sites offering helpful information, schedules of free self-help clinics, forms, and legal education documents that give you basic information on a number of legal problems.\",\r\n                \"resourceType\": \"Organizations\",\r\n                \"externalUrl\": null,\r\n                \"url\": \"https://alaskalawhelp.org/\",\r\n                \"topicTags\": null,\r\n                \"location\": [\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Kalawao\",\r\n                    \"zipCode\": \"96761\"\r\n                  },\r\n                  {\r\n                    \"state\": \"Hawaii\",\r\n                    \"county\": null,\r\n                    \"city\": \"Honolulu\",\r\n                    \"zipCode\": \"96741\"\r\n                  }\r\n                ],\r\n                \"icon\": \"./assets/images/resources/resource.png\",\r\n                \"createdBy\": \"\",\r\n                \"createdTimeStamp\": null,\r\n                \"modifiedBy\": \"\",\r\n                \"modifiedTimeStamp\": \"2018-04-01T04:18:00Z\"\r\n              }\r\n            ]\r\n          }\r\n        ]\r\n      }\r\n    ],\r\n    \"isShared\": false\r\n  }\r\n}";
        public static JObject a2jPersonalizedPlan = JObject.Parse(@"{ 'id': '86e693bd-c673-419f-95c4-9ee76cccab3c',
  'topics': [
    {
      'topicId': 'd1d5f7a0-f1fa-464f-8da6-c2e7ce1501ef',
      'steps': [
