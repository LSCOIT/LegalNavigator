...
describe("ArticlesComponent", () => {
  ...
  let mockArticleResource = {
    overview:
      'This article gives introductory information about registering a custody or child support order from another state with the Alaska courts.  An order from another state is sometimes called a "foreign order."',
    contents: [
      {
      ...
      {
        headline:
          "How long does it take for the registration to become effective?",
        content:
    ...
    name:
      "Introduction to Registering a Custody or Child Support Order from Another State",
    resourceCategory: null,
    description:
      "Introductory information about registering a custody or child support order from another state with the Alaska courts.",
