...
describe('SaveButtonService', () => {
  ...
  beforeEach(() => {
    mockPersonalizedPlanService = jasmine.createSpyObj(['userPlan', 'showSuccess']);
    ...
    service = new SaveButtonService(mockPersonalizedPlanService, global, mockProfileComponent);

    TestBed.configureTestingModule({
      providers: [SaveButtonService,
        { provide: PersonalizedPlanService, useValue: mockPersonalizedPlanService },
        { provide: Global, useValue: { global, userId: "userId", planSessionKey: "planKey" } },
