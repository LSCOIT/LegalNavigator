...
describe('ServiceOrgSidebarComponent',() =>
{
  ...
  let mockMapLocation: MapLocation = { state: 'teststate', city: 'testcity', county: 'testcounty', zipCode: '000007', locality: undefined, address: undefined };
  ...
  beforeEach(async(() =>
  {
    TestBed.configureTestingModule
      ({
        ...
        providers: [ServiceOrgService, LocationService],
