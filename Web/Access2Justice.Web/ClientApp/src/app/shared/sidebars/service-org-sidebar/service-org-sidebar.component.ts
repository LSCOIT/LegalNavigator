...
export class ServiceOrgSidebarComponent implements OnInit {
  ...
  resourceFilter: IResourceFilter = { ResourceType: '', ContinuationToken: '', TopicIds: [], ResourceIds: [], PageNumber: 0, Location: {}, IsResourceCountRequired: false, IsOrder: false, OrderByField:'' };
  topicIds: string[] = [];
  total: number = 5;
  ...
  getOrganizations() {
    ...
    this.resourceFilter = {
      ...
      PageNumber: 0, ContinuationToken: '', IsResourceCountRequired: false, ResourceIds: [], IsOrder: false, OrderByField:''
    }
