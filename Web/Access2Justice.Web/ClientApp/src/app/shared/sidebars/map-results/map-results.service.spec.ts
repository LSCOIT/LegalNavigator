...
describe("MapResults Service", () => {
  ...
  let mockMapResult = {
        ...
        resources: [
          {
            ...
            point: {
              type: "Point",
              coordinates: [21.3048686981201, -157.858184814453]
            },
            address: {
              adminDistrict: "HI",
              adminDistrict2: "Honolulu County",
              countryRegion: "United States",
              formattedAddress: "96813, HI",
              locality: "Honolulu",
              postalCode: "96813"
            },
            confidence: "High",
    ...
    traceId:
      "93c6f159e49040469858aea8b1213926|BN20300154|7.7.0.0|Ref A: 71844B79CA2B49C39955089F6B01A541 Ref B: BLUEDGE0521 Ref C: 2018-06-13T08:42:10Z"
  };
  ...
  it("should return map results", done => {
    ...
    service
      .getLocationDetails(mockAddress, mockCredentials)
