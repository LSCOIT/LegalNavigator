...
describe("GuidedAssistantComponent", () => {
  ...
  beforeEach(async(() => {
    ...
    mockSearchResponse = {
      ...
      topics: [
        {
          ...
          overview:
            "Overview of the Problems with My Landlord, Home, or Apartment topic",
          quickLinks: [
            {
              text: "Apartment Rules",
              url:
                "https://alaskalawhelp.org/resource/apartment-rules?ref=o4LzP"
            },
            {
              text:
                "Conversations about Landlord Tenant Law in Alaska: Introduction",
              url:
                "https://alaskalawhelp.org/resource/conversations-about-landlord-tenant-law-in-alaska-introduction"
            }
          ],
          parentTopicId: [
            {
      ...
      topicIds: ["1370ccb7-3f0a-4b0f-920e-2d12660fafa7"],
