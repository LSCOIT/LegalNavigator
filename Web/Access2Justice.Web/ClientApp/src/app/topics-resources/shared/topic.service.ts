...
export class TopicService {
  ...
  topicUrl = "http://localhost:59019/api/topics/get";
  subtopicUrl = "http://localhost:59019/api/topics/getsubtopics";
  subtopicDetailUrl = "http://localhost:59019/api/topics/getsubtopicdetails";
