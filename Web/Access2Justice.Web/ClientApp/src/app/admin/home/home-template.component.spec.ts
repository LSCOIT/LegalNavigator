...
describe('HomeTemplateComponent', () => {
    ...
    mockStaticContent = [
      {
        ...
        "hero": {
          ...
          "image": {
            "source": "/static-resource/hawaii/assets/images/primary-illustrations/hawaii.svg",
        ...
        "guidedAssistantOverview": {
          ...
          "description": {
            "steps": [
              ...
              {
                "order": "2",
                "description": "We'll create a personalized plan with steps and resources."
              },
              {
                "order": "3",
          ...
          "image": {
            "source": "/static-resource/hawaii/assets/images/secondary-illustrations/guided_assistant.svg",
        ...
        "privacy": {
          ...
          "image": {
            "source": "/static-resource/hawaii/assets/images/secondary-illustrations/privacy_promise.svg",
  ...
  it('should set newHomeContent and call saveHomeData on submit', () => {
    ...
    component.getHomePageContent();
    component.onSubmit(formValue);
    expect(component.newHomeContent.hero.description.text).toEqual("hero Description");
    expect(component.newHomeContent.guidedAssistantOverview.description.steps[0].description)
